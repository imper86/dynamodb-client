...
final readonly class DynamoDBClient implements DynamoDBClientInterface
{
    ...
    {
        return $this->sendRequest('DynamoDB_20120810.SearchVectors', $request, SearchVectorsResponse::class);
    }
    ...
    {
        return $this->sendRequest('DynamoDB_20120810.UpdateTable', $request, UpdateTableResponse::class);
    }

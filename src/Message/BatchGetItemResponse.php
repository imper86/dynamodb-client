...
final readonly class BatchGetItemResponse
{
    /**
    ...
    public function __construct(
        public ItemListMap $responses = new ItemListMap(),
        public KeysAndAttributesMap $unprocessedKeys = new KeysAndAttributesMap(),

...
{
    private const REQUEST_FIXTURE = __DIR__ . '/fixtures/describe-time-to-live-request.json';

    private const RESPONSE_FIXTURE = __DIR__ . '/fixtures/describe-time-to-live-response.json';

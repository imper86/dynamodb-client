...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/describe-table-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/describe-table-response.json';

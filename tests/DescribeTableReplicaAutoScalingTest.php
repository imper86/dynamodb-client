...
{
    private const REQUEST_FIXTURE = __DIR__ . '/fixtures/describe-table-replica-auto-scaling-request.json';

    private const RESPONSE_FIXTURE = __DIR__ . '/fixtures/describe-table-replica-auto-scaling-response.json';

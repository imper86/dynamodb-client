...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/put-item-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/put-item-response.json';

...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/disable-kinesis-streaming-destination-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/disable-kinesis-streaming-destination-response.json';

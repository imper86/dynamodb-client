...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/list-contributor-insights-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/list-contributor-insights-response.json';

...
{
    private const REQUEST_FIXTURE = __DIR__ . '/fixtures/transact-get-items-request.json';

    private const RESPONSE_FIXTURE = __DIR__ . '/fixtures/transact-get-items-response.json';

...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/search-vectors-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/search-vectors-response.json';

...
/**
 * The EnableKinesisStreamingDestination reference has no Examples section, so the fixtures are built
 * from its request and response syntax, starting a `Music` table streaming to `MusicStream`.
 *
...
final class EnableKinesisStreamingDestinationTest extends TestCase
{
    ...
    public function testSendsTheRequestTheWayTheApiReferenceDocumentsIt(): void
    {
        ...
        $this->createClient($httpClient)->enableKinesisStreamingDestination($this->documentedRequest());
    ...
    public function testLeavesTheStreamingConfigurationOutWhenItIsNotGiven(): void
    {
        ...
        $this->createClient($httpClient)->enableKinesisStreamingDestination(
            new EnableKinesisStreamingDestinationRequest(self::STREAM_ARN, 'Music'),
        );
    ...
    public function testReturnsTheStatusOfTheDestination(): void
    {
        ...
        $response = $this->createClient($httpClient)->enableKinesisStreamingDestination($this->documentedRequest());

        self::assertSame(DestinationStatus::ENABLING, $response->destinationStatus);
    ...
    public function testRejectsAStreamArnShorterThanTheServiceAllows(): void
    {
        ...
        new EnableKinesisStreamingDestinationRequest(str_repeat('a', 36), 'Music');
    }
    ...
    public function testRejectsAStreamArnLongerThanTheServiceAllows(): void
    {
        ...
        new EnableKinesisStreamingDestinationRequest(str_repeat('a', 1025), 'Music');
    }
    ...
    public function testRejectsATableNameLongerThanTheServiceAllows(): void
    {
        ...
        new EnableKinesisStreamingDestinationRequest(self::STREAM_ARN, str_repeat('a', 1025));
    }

    /**
     * @throws InvalidArgumentException
     */
    private function documentedRequest(): EnableKinesisStreamingDestinationRequest
    {
        return new EnableKinesisStreamingDestinationRequest(

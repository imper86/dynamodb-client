...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/delete-table-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/delete-table-response.json';

...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/describe-contributor-insights-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/describe-contributor-insights-response.json';

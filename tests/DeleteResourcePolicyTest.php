...
{
    private const REQUEST_FIXTURE = __DIR__ . '/fixtures/delete-resource-policy-request.json';

    private const RESPONSE_FIXTURE = __DIR__ . '/fixtures/delete-resource-policy-response.json';

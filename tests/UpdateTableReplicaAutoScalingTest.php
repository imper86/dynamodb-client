...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/update-table-replica-auto-scaling-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/update-table-replica-auto-scaling-response.json';

    private const string ROLE_ARN = 'arn:aws:iam::123456789012:role/aws-service-role/'

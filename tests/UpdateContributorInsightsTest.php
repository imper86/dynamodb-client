...
{
    private const REQUEST_FIXTURE = __DIR__ . '/fixtures/update-contributor-insights-request.json';

    private const RESPONSE_FIXTURE = __DIR__ . '/fixtures/update-contributor-insights-response.json';

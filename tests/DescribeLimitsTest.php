...
{
    private const string REQUEST_FIXTURE = __DIR__ . '/fixtures/describe-limits-request.json';

    private const string RESPONSE_FIXTURE = __DIR__ . '/fixtures/describe-limits-response.json';
